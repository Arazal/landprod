...
function isVisible(elem) {
  ...
  var windowHeight = document.documentElement.clientHeight; // видны верхний ИЛИ нижний край элемента
...
function showVisible() {
  var _iterator = _createForOfIteratorHelper(document.querySelectorAll('img')),
      _step;
